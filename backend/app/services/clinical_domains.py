...
def serialize_lab_order(row: m.LabOrder) -> dict:
    return {
        ...
        "order_profile": row.order_profile or {},
...
def serialize_pharmacy_dispense(row: m.PharmacyDispense) -> dict:
    return {
        ...
        "dispense_profile": row.dispense_profile or {},
        "created_at": row.created_at,
        "updated_at": row.updated_at,
    }
...
def serialize_nursing_task(row: m.NursingTask) -> dict:
    return {
        ...
        "care_profile": row.care_profile or {},
        "created_at": row.created_at,
        "updated_at": row.updated_at,
    }
...
def create_lab_order(
    ...
    *,
    ...
    row = m.LabOrder(
        ...
        test_code=test_code,
        status="ordered",
        order_profile=order_profile or {},
        created_by=actor_id,
        updated_by=actor_id,
...
def create_pharmacy_dispense(
    ...
    *,
    ...
    qty: Decimal,
    actor_id: UUID,
    dispense_profile: Optional[dict] = None,
    ...
    row = m.PharmacyDispense(
        ...
        dispense_profile=dispense_profile or {},
        created_by=actor_id,
        updated_by=actor_id,
        correlation_id=correlation_id,
    )
...
def create_nursing_task(
    ...
    *,
    ...
    task_type: str,
    actor_id: UUID,
    care_profile: Optional[dict] = None,
    admission_id: Optional[UUID] = None,
