...
def serialize_ot(row: m.OtProcedure) -> dict:
    return {
        ...
        "procedure_tariff_id": str(row.procedure_tariff_id) if row.procedure_tariff_id else None,
        "surgeon_id": str(row.surgeon_id) if row.surgeon_id else None,
        "theatre_code": row.theatre_code,
        "theatre_id": str(row.theatre_id) if row.theatre_id else None,
        "status": row.status,
...
def create_ot_procedure(
    ...
    *,
    ...
    row = m.OtProcedure(
        ...
        procedure_tariff_id=procedure_tariff_id,
